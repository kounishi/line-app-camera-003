      ...
      <div class="screen-body">
        ...
        <section class="card section-gap">
          ...
          <ol class="howto-steps">
            <li>トーク画面のリッチメニューをタップすると、メニュー名(例:「各種申請」)がトークに送信されます</li>
            <li>公式アカウントがそのメニュー名に応答し、該当機能を開くリンクを返信します</li>
            <li>リンクをタップすると、このミニアプリの該当画面が直接開きます</li>
          </ol>
          <p class="card-text">各種申請・ご請求額・契約状況は、初回のみLINEアカウントと顧客コードの紐付けが必要です。紐付け済みの場合はそのまま該当画面が開きます。</p>
        </section>
